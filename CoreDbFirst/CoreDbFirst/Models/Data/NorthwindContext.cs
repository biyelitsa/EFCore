...
namespace CoreDbFirst.Models.Data
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<EmpMan> EmpMen { get; set; }
        public virtual DbSet<EmpWoman> EmpWomen { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-5L32GAB\\SQLEXPRESS;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmpMan>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("empMan");
            ...
            modelBuilder.Entity<EmpWoman>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("empWomen");
