    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FatMasters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FatMasters_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FatDetails", x => new { x.Id, x.ProductId });
                    table.ForeignKey(
                        name: "FK_FatDetails_FatMasters_Id",
                        column: x => x.Id,
                        principalTable: "FatMasters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
